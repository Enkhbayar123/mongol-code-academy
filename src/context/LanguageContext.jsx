...
const translations = {
  mn: {
    ...
    login_welcome: "Буцаад тавтай морил",
    login_sub: "Нэвтрээд программчлалын аяллаа үргэлжлүүлээрэй",
    login_email: "Мэйл хаяг",
    login_password: "Нууц үг",
    login_btn: "Нэвтрэх",
    loading_text: "Уншиж байна...",
    login_no_acc: "Бүртгэл байхгүй юу?",
    login_create_acc: "Бүртгэл үүсгэх",
    err_login_general: "Таны нэвтрэх хаяг эсвэл нууц үг буруу байна.",
    err_login_creds: "Имэйл эсвэл нууц үг буруу байна.",
    err_login_too_many: "Хэт олон удаа оролдлоо. Түр хүлээгээд дахин оролдоно уу.",

    reg_title: "Бүртгэл Үүсгэх",
    reg_sub: "Бидэнтэй нэгдэж, өөрийн программчлалын аяллыг эхлүүлээрэй",
    reg_yt_text: "Биднийг дэмжиж, манай YouTube сувгийг дагаарай.",
    reg_yt_btn: "🎬 Subscribe дарах",
    reg_yt_checkbox: "Би Subscribe дарсан (Заавал дарах ёстой)",
    reg_fullname: "Бүтэн нэр",
    reg_age: "Нас",
    reg_email: "Мэйл хаяг",
    reg_country: "Оршин буй газар",
    reg_experience: "Программчлалын туршлага",
    exp_beginner: "Анхан түвшин",
    exp_intermediate: "Дунд түвшин",
    exp_advanced: "Ахисан түвшин",
    reg_reason: "Манай платформыг ашиглаж буй шалтгаан (заавал биш)",
    reg_password: "Нууц үг (багадаа 6 оронтой)",
    reg_btn: "Бүртгэл үүсгэх",
    reg_already_acc: "Бүртгэл аль хэдийн үүсгэсэн үү?",
    reg_login_link: "Нэвтрэх",
    err_reg_yt: "Та манай YouTube сувагт Subscribe дарсан байх шаардлагатай.",
    err_reg_general: "Бүртгэл үүсгэхэд алдаа гарлаа. Дахин оролдоно уу.",
    err_reg_email_in_use: "Энэ имэйл хаяг бүртгэлтэй байна.",
    err_reg_weak_pwd: "Нууц үг хэтэрхий сул байна. (6-аас дээш оронтой байх ёстой)",
    err_reg_invalid_email: "Имэйл хаяг буруу байна.",
  ...
  ko: {
    ...
    login_sub: "로그인하여 프로그래밍 여정을 계속하세요",
    login_email: "이메일 주소",
    login_password: "비밀번호",
    login_btn: "로그인",
    loading_text: "로딩 중...",
    login_no_acc: "계정이 없으신가요?",
    login_create_acc: "회원가입",
    err_login_general: "이메일 또는 비밀번호가 올바르지 않습니다.",
    err_login_creds: "이메일 또는 비밀번호가 올바르지 않습니다.",
    err_login_too_many: "로그인 시도가 너무 많습니다. 잠시 후 다시 시도해 주세요.",

    reg_title: "회원가입",
    reg_sub: "우리와 함께 프로그래밍 여정을 시작해 보세요",
    reg_yt_text: "저희를 응원하고 유튜브 채널을 구독해 주세요.",
    reg_yt_btn: "🎬 유튜브 구독하기",
    reg_yt_checkbox: "유튜브를 구독했습니다 (필수 항목)",
    reg_fullname: "이름 (성명)",
    reg_age: "나이",
    reg_email: "이메일 주소",
    reg_country: "거주 국가 / 지역",
    reg_experience: "프로그래밍 경험 수준",
    exp_beginner: "초급 (입문)",
    exp_intermediate: "중급",
    exp_advanced: "고급",
    reg_reason: "가입 경로 및 목적 (선택사항)",
    reg_password: "비밀번호 (최소 6자)",
    reg_btn: "계정 만들기",
    reg_already_acc: "이미 계정이 있으신가요?",
    reg_login_link: "로그인",
    err_reg_yt: "유튜브 채널 구독 확인 체크박스에 체크해 주셔야 합니다.",
    err_reg_general: "회원가입 중 오류가 발생했습니다. 다시 시도해 주세요.",
    err_reg_email_in_use: "이미 사용 중인 이메일 주소입니다.",
    err_reg_weak_pwd: "비밀번호가 너무 취약합니다. (최소 6자 이상)",
    err_reg_invalid_email: "올바르지 않은 이메일 형식입니다.",
  ...
  en: {
    ...
    login_sub: "Log in to continue your programming journey",
    ...
    err_login_general: "Incorrect login email or password.",
    err_login_creds: "Incorrect email or password.",
    err_login_too_many: "Too many login attempts. Please try again later.",

    reg_title: "Create Account",
    reg_sub: "Join us and kickstart your programming journey",
    reg_yt_text: "Please support us by subscribing to our YouTube channel.",
    reg_yt_btn: "🎬 Subscribe Now",
    reg_yt_checkbox: "I have subscribed (Required)",
    reg_fullname: "Full Name",
    reg_age: "Age",
    reg_email: "Email Address",
    reg_country: "Country of Residence",
    reg_experience: "Programming Experience",
    exp_beginner: "Beginner",
    exp_intermediate: "Intermediate",
    exp_advanced: "Advanced",
    reg_reason: "Reason for joining our platform (Optional)",
    reg_password: "Password (At least 6 characters)",
    reg_btn: "Create Account",
    reg_already_acc: "Already have an account?",
    reg_login_link: "Log In",
    err_reg_yt: "You must subscribe to our YouTube channel to register.",
    err_reg_general: "An error occurred during registration. Please try again.",
    err_reg_email_in_use: "This email address is already in use.",
    err_reg_weak_pwd: "The password is too weak. (Must be at least 6 characters)",
    err_reg_invalid_email: "The email address is invalid.",
